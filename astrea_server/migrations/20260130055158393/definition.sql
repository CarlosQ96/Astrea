...
--
-- Class DeviceToken as table device_tokens
--
...
--
-- Class UserSettings as table user_settings
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('astrea', '20260130055158393', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260130055158393', "timestamp" = now();
